...
theta <- c(beta1=1e-2,beta2=1e-4,gamma=0.25)

data1 <- Bart_Haddon

posTdC <- function(theta){
  
  my_fitmodel1 <- bart_det
...
init.theta <- theta
lower <- c(beta1=0,beta2=0,gamma=0)
upper <- c(beta1=1,beta2=1,gamma=1)
...
save(my_mcmc.TdC,my_mcmc.TdC2,file='Bart.ch1.RData')